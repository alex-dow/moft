...
module Moft
  class Site
    attr_accessor :config, :layouts, :posts, :pages, :static_files,
                  :categories, :exclude, :include, :static_includes, :source, :dest, :lsi, :pygments,
    ...
    def initialize(config)
      ...
      self.static_includes = config['static_includes']
    ...
    # Returns nothing.
    def read
      self.read_static_includes
      self.read_layouts
      self.read_directories
    end
    
    def read_static_includes
      self.static_includes.each do |s|
        self.read_directories(s)
      end
    end
